...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'include/img/slider-images/image01.jpg', title : '<div class="slide-content">Club Capra: Robots Terrestres Autonomes</div>', thumb : '', url : ''},
											{image : 'include/img/slider-images/image02.jpg', title : '<div class="slide-content">Club Capra: Robots Terrestres Autonomes</div>', thumb : '', url : ''},
											{image : 'include/img/slider-images/image03.jpg', title : '<div class="slide-content">Club Capra: Robots Terrestres Autonomes</div>', thumb : '', url : ''}
									],
